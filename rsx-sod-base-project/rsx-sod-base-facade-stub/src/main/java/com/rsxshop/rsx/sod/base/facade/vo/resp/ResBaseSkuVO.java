package com.rsxshop.rsx.sod.base.facade.vo.resp;
...
@ApiModel(description = "商品信息响应实体")
@Data
public class ResBaseSkuVO implements Serializable {

    private static final long serialVersionUID = -4532113782831003729L;
     ...
     * sku主图
     * */
    @ApiModelProperty(name = "mainImage",value = "sku主图")
